...
export const MediaProvider = ({ children }) => {
  const [mediaItems, setMediaItems] = useState([
    { 
      ...
      review: 'Dirty Dancing is a classic film that is so memorable that it is hard to say anything negative about it...', 
    ...
    { 
      ...
      review: 'A surprisingly funny family movie.', 
    ...
    { 
      ...
      review: 'The one that started the magic.', 
    ...
    { 
      ...
      review: 'A great continuation of the story.', 
    ...
    { 
      ...
      review: 'Visually stunning and darker tone.', 
    ...
    { 
      ...
      review: 'The Triwizard Tournament was epic.', 
    ...
    { 
      ...
      review: 'Dumbledore\'s Army unites.', 
    ...
    { 
      ...
      review: 'Discovering Voldemort\'s past.', 
    ...
    { 
      ...
      review: 'A quirky and charming romance.', 
    ...
    { 
      ...
      review: 'An absolutely iconic performance by Meryl Streep.', 
    ...
    { 
      ...
      review: 'The greatest character arc in television history.', 
